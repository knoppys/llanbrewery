...
function scp_front_scripts() {    
    ...
    wp_enqueue_script( 'slickjs', 'http://cdn.jsdelivr.net/jquery.slick/1.5.0/slick.min.js', array('jquery'), '', true );
   	//wp_enqueue_script( 'imagesloaded', 'https://npmcdn.com/imagesloaded@4.1/imagesloaded.pkgd.min.js', array('jquery'), '', true );
    wp_enqueue_script( 'core', get_template_directory_uri() . '/js/core.js', array('jquery'), '', true );
}
...
* Featured Images
****************************/
add_theme_support( 'post-thumbnails', array( 'page', 'post', 'product' ) );          // Pages only


/***************************
* Remove default sorting dropdown from woocommerce archive pages
****************************/ 
